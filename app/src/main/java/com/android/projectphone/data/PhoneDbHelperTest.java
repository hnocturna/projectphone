...
import com.android.projectphone.CategoricalSpec;
import com.android.projectphone.MainActivity;
import com.android.projectphone.NumericalSpec;
import com.android.projectphone.Phone;
import com.android.projectphone.SplashScreen;
import com.android.projectphone.UserCatReq;
import com.android.projectphone.UserNumReq;
import com.android.projectphone.UserReq;
 ...
 */
public final class PhoneDbHelperTest extends SQLiteOpenHelper {
    ...
    public PhoneDbHelperTest(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        for (String key : SplashScreen.map.keySet()) {
            ...
            // Log.d("PhoneDbHelperTest", CREATE_BOOK_TABLE.toString()); // Debug purposes
    ...
    private Map<Integer, String> getNumSpecPhones(UserReq userReq) {
        ...
        while (!cursor.isAfterLast()) {
            ...
            if (choiceList != null) {
                ...
                if (phoneSpec == null || phoneSpec.contains("Yes")) {
                    cursor.moveToNext();
                    continue;
                }
                Log.v("Known.getNumSpecPhones", "Phone spec: " + phoneSpec);
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    if (specificPhones != null) {
                        ...
                        if (specificPhones.contains(phone) && i == 0 && !candidatePhones.values().contains(phone)) {
                            candidatePhones.put(popularity, phone);
                            Log.d("PhoneDbHelperTest", "Specific phone: " + phone + " added!");
                            cursor.moveToNext();
                            continue;
